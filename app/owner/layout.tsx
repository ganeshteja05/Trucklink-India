...
import {
  LayoutDashboard, Truck, Package, TrendingUp, Shield, Bell,
...
const navItems = [
  ...
  { href: '/owner/trucks', label: 'My Trucks', icon: Truck },
  { href: '/owner/bookings', label: 'Bookings', icon: Package },
  { href: '/owner/return-loads', label: 'Return Loads', icon: TrendingUp },
  { href: '/owner/verification', label: 'Verification', icon: Shield },
